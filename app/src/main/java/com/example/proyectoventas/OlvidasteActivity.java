                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(OlvidasteActivity.this, "Correo enviado", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(OlvidasteActivity.this, LoginActivity.class);
                            startActivity(intent);
                            finish();
                        } else {
                            Toast.makeText(OlvidasteActivity.this, "Correo inválido", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
